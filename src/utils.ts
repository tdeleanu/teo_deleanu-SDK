...
export function getOptionsFromArgs(args: RequestArgs): Options {
  ...
  if (args.length > 0) {
    ...
    if (typeof arg === 'string') {
      ...
      if (params.lotrAccount) {
        opts.headers['Lotr-Account'] = params.lotrAccount;
      }
      if (params.apiVersion) {
        opts.headers['Lotr-Version'] = params.apiVersion;
      }
...
export function protoExtend(
  this: any,
  sub: any
): {new (...args: any[]): LotrResourceObject} {
  // eslint-disable-next-line @typescript-eslint/no-this-alias
  const Super = this;
  const Constructor = Object.prototype.hasOwnProperty.call(sub, 'constructor')
    ? sub.constructor
    : function(this: LotrResourceObject, ...args: any[]): void {
...
export function emitWarning(warning: string): void {
  ...
  return process.emitWarning(warning, 'Lotr');
}

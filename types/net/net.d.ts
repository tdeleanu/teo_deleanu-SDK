...
declare module 'lotr' {
  namespace LotrSDK {
    /**
     * Encapsulates the logic for issuing a request to the LOTR API. This is
    ...
    export const createNodeHttpClient: (
      ...
      HttpClientResponse<IncomingMessage, LotrSDK.LotrStreamResponse>
    >;
